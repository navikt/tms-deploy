...
def validate(args, parser):
    ...
    if args.ssr is True and "http" not in args.url:
        parser.error("Feil i discovery url, den må starte med http")

    if args.ssr is False and "https://cdn.nav.no" not in args.url:
